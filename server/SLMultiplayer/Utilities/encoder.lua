...
function SLEncoder.BytesToUint8(bytes)
...
function SLEncoder.Uint16ToBytes(uint16)
...
function SLEncoder.BytesToUint16(bytes)
  if type(bytes) ~= 'string' then
    return false
  end
...
function SLEncoder.Uint32ToBytes(uint32)
...
function SLEncoder.BytesToUint32(bytes)
  if type(bytes) ~= 'string' then
    return false
  end
...
function SLEncoder.FloatToBytes(float)
...
function SLEncoder.BytesToFloat(bytes)
  if type(bytes) ~= 'string' then
    return false
  end
  local sign = 1
